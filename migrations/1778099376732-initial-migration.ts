...
export class InitialMigration1778099376732 implements MigrationInterface {
    name = 'InitialMigration1778099376732'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "control_measures" ADD CONSTRAINT "FK_94ec740f221555c9bbef1ed2b75" FOREIGN KEY ("risk_assessment_id") REFERENCES "risk_assessments"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "control_measures" ADD CONSTRAINT "FK_e40fa09f040376161389197e7b9" FOREIGN KEY ("responsible_id") REFERENCES "users"("id") ON DELETE RESTRICT ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE "hazards" ADD CONSTRAINT "FK_f188b63f5f4c64c727349c911d5" FOREIGN KEY ("company_id") REFERENCES "companies"("id") ON DELETE RESTRICT ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE "risk_assessments" ADD CONSTRAINT "FK_262f2e17dfbfc936d5ad08c8251" FOREIGN KEY ("work_area_id") REFERENCES "work_areas"("id") ON DELETE RESTRICT ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE "risk_assessments" ADD CONSTRAINT "FK_3750236cb40853899cf00fb8118" FOREIGN KEY ("hazard_id") REFERENCES "hazards"("id") ON DELETE RESTRICT ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "risk_assessments" ADD CONSTRAINT "FK_5051d52e625bac8257da9b5de8d" FOREIGN KEY ("responsible_id") REFERENCES "users"("id") ON DELETE RESTRICT ON UPDATE NO ACTION`);
    }

    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "risk_assessments" DROP CONSTRAINT "FK_5051d52e625bac8257da9b5de8d"`);
        await queryRunner.query(`ALTER TABLE "risk_assessments" DROP CONSTRAINT "FK_3750236cb40853899cf00fb8118"`);
        await queryRunner.query(`ALTER TABLE "risk_assessments" DROP CONSTRAINT "FK_1072a85f2c8cadd0506f13bdd1d"`);
        await queryRunner.query(`ALTER TABLE "risk_assessments" DROP CONSTRAINT "FK_262f2e17dfbfc936d5ad08c8251"`);
        ...
        await queryRunner.query(`ALTER TABLE "hazards" DROP CONSTRAINT "FK_f188b63f5f4c64c727349c911d5"`);
        ...
        await queryRunner.query(`ALTER TABLE "control_measures" DROP CONSTRAINT "FK_e40fa09f040376161389197e7b9"`);
        await queryRunner.query(`ALTER TABLE "control_measures" DROP CONSTRAINT "FK_94ec740f221555c9bbef1ed2b75"`);
